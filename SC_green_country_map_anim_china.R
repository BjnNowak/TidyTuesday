...
rst<-tibble(
  nm=c(
    # 2019
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Ja_to_Ma_2019.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Av_to_Ju_2019.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Ju_to_Se_2019.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Oc_to_De_2019.tif',
    # 2020
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Ja_to_Ma_2020.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Av_to_Ju_2020.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Ju_to_Se_2020.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Oc_to_De_2020.tif',
    # 2021
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Ja_to_Ma_2021.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Av_to_Ju_2021.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Ju_to_Se_2021.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/China/median_NDVI_China_Oc_to_De_2021.tif'
  )
)
...
pl<-ggplot()+
  ...
  annotate(
    "text",x=20,
    y=.50,label=tib$season[i],
    family="ral",size=13,hjust=0,
    color="forestgreen",fontface="bold"
  )+
  annotate(
    "segment",x=-20,xend=-20,y=.15,yend=.55,lwd=0.25,
    color="white"
  )+
  annotate(
    "text",x=-79,y=.35,label="Normalized Difference Vegetation Index (NDVI)",
...
# Make animation
gg_playback(
  name = file.path(tempdir(), "recording", "ndvi_china.gif"),
