...
pal<-scico(7, palette = 'bamako',direction=-1)
...
theme_cust<-theme(
  ...
  plot.title = element_text(size=100,family="sta",color="black",hjust=0.5,margin=margin(1,0,0.25,0,"cm"))
)
