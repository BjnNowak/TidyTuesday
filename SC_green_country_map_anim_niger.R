...
rst<-tibble(
  nm=c(
    # 2019
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Ja_to_Ma_2019.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Av_to_Ju_2019.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Ju_to_Se_2019.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Oc_to_De_2019.tif',
    # 2020
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Ja_to_Ma_2020.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Av_to_Ju_2020.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Ju_to_Se_2020.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Oc_to_De_2020.tif',
    # 2021
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Ja_to_Ma_2021.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Av_to_Ju_2021.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Ju_to_Se_2021.tif',
    'https://github.com/BjnNowak/TidyTuesday/raw/main/map/ndvi/Niger/median_NDVI_Niger_Oc_to_De_2021.tif'
  )
)
...
pl<-ggplot()+
  ...
  annotate(
    "text",x=20,
    y=.35,label=tib$season[i],
    family="ral",size=13,hjust=0,
    color="forestgreen",fontface="bold"
  )+
  annotate(
    "segment",x=-20,xend=-20,y=0,yend=.4,lwd=0.25,
    color="white"
  )+
  annotate(
    "text",x=-79,y=.2,label="Normalized Difference Vegetation Index (NDVI)",
