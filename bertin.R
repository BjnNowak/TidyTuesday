...
ggplot()+
  ...
  geom_sf(
    ...
    pch=21,color=alpha("white",1),fill="black",stroke=0.25
  )+
  scale_size_manual(
    values=c(0.5,1,1.5,1.75,2.25),
  ...
  theme(
    ...
    legend.title = element_markdown(
      family="bit",size=28,color="black",lineheight=0.35,
      margin=margin(0,0,-0.35,0,"cm")
    ),
    legend.text = element_text(
      family="fira",size=20,color="black",
